...
export default App = () => {
  ...
  return (
    <>
      ...
      <p>
        <b>Ans:</b>For understding How react work. you need to know how the page
        transform into react component.frome vanila html to transform react
        component you need understand the steps.here is an overview:
      </p>
      <ol>
        <li>
        ...
        <li>
          ...
          virtualDom and when the virtualDom sucessfully rendered. then, it will
          started rendeing to the actual Dom. For rendering to the actual dom it
          must required a specific dom element as root element. where all the
          react component will be render.for example:
          <ul type="square">
            <li>
              <p>&lt;div id="root" &gt; &lt;/div &gt; </p>
            </li>
            <li>
              <b>Pitfall:</b>It can't select body as a root because our js file
              also a part of body. if it will try to render the body as a root
              our js file will disappear which can be error prone. that's why it
              always select a div as a child.
            </li>
            <li>
              ReactDom is responsible to create a bridge between the actual dom
              & the virtualDom.it's acts as an entry point. when the root is
              select by the selector then the root passes to the
        ...
        <li>
          ...
          local varibale and selectors. but in react this things might not work.
          Because react component parses differently.
        </li>
      </ol>
      <p>
        <b>Conclusion:</b>What we did to manipulate the dom in vanila js. might
        not work in react because it's own parsing nature. we will se how react
        different from the vanila js.
      </p>
      <hr />
